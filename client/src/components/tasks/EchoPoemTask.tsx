  ...
  return (
    ...
    >
      ...
      <motion.div
          ...
          className="mb-8"
        >
          <p className="text-sm mb-4" style={{ color: '#8BA4B8', fontFamily: 'Noto Serif SC, serif' }}>
              ...
              <div className="flex flex-wrap gap-1 justify-center">
                {melody.map((note, index) => (
                  <motion.div
                    ...
                    className={`relative text-sm px-2 py-1 rounded group transition-all cursor-move ${
          ...
          {playPhase && (
            ...
            >
              <p className="text-sm" style={{ color: '#8BA4B8', fontFamily: 'Noto Serif SC, serif' }}>
          ...
          {melody.length >= 30 && (
            <motion.button
              ...
              onClick={handlePlay}
              disabled={isPlaying}
              className="mt-4 px-6 py-2 rounded-lg border transition-all disabled:opacity-50"
              style={{
                background: 'rgba(139, 164, 184, 0.1)',
                borderColor: 'rgba(139, 164, 184, 0.5)',
                color: '#8BA4B8',
      ...
      {showResponse && (
        ...
        >
          ...
          <p className="text-xs mb-4" style={{ color: '#d4c5a0', fontFamily: 'Noto Serif SC, serif' }}>
