  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: VIEWPORT_WIDTH, maxWidth: '100%', height: Math.ceil(CARD_HEIGHT * 1.12) + 16 }}
...
export default function EpilogueScene({
  ...
  return (
    <div className="fixed inset-0">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-full px-4 sm:px-6 pt-14 pb-20 overflow-y-auto">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
